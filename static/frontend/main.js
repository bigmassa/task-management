...
var TaskCardComponent = /** @class */ (function () {
    ...
    TaskCardComponent.prototype.ngOnChanges = function (changes) {
        if (lodash__WEBPACK_IMPORTED_MODULE_0__["has"](changes, 'id.currentValue')) {
            ...
            this.taskTags$ = this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_3__["select"])(Object(_state_selectors_task__WEBPACK_IMPORTED_MODULE_2__["getTaskTagsForTask"])(this.id)));
