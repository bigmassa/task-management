...
var TaskFormComponent = /** @class */ (function () {
    ...
    TaskFormComponent.prototype.getOrCreateEditNoteForm = function (note) {
        if (!lodash__WEBPACK_IMPORTED_MODULE_0__["has"](this.taskNoteForms, note.id)) {
            var form = new _forms_task_note_form__WEBPACK_IMPORTED_MODULE_15__["TaskNoteForm"](this.store, this.actionsSubject, { alwaysEditable: false, cleanAfterMethod: _forms_base_form__WEBPACK_IMPORTED_MODULE_6__["FormCleanAfterMethod"].loadSaved });
            form.load(note);
