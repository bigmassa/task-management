...
from wip.api import RelationshipViewSet
from wip.api.relationship import RelationshipFilter
...
class TestAPI(AppTestCase):
    ...
    def setUp(self):
        ...
        self.base_url = reverse('api:relationship-list')
        self._create_test_object()

    def _create_test_object(self):
        self.test_object = Relationship.objects.first()
        self.test_object_data = RelationshipSerializer(instance=self.test_object).data
        self.test_object_url = self.base_url + str(self.test_object.pk) + '/'

    def test_filter_class(self):
        self.assertEqual(RelationshipViewSet.filter_class, RelationshipFilter)
