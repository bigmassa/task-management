...
from wip.api import JobTimingViewSet
from wip.api.job_timing import JobTimingFilter
...
class TestAPI(AppTestCase):
    ...
    def setUp(self):
        ...
        self.base_url = reverse('api:jobtiming-list')
        self._create_test_object()

    def _create_test_object(self):
        self.test_object = JobTiming.objects.first()
        self.test_object_data = JobTimingSerializer(instance=self.test_object).data
        self.test_object_url = self.base_url + str(self.test_object.pk) + '/'

    def test_filter_class(self):
        self.assertEqual(JobTimingViewSet.filter_class, JobTimingFilter)
