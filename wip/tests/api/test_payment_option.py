...
from wip.api import PaymentOptionViewSet
from wip.api.payment_option import PaymentOptionFilter
...
class TestAPI(AppTestCase):
    ...
    def setUp(self):
        ...
        self.base_url = reverse('api:paymentoption-list')
        self._create_test_object()

    def _create_test_object(self):
        self.test_object = PaymentOption.objects.first()
        self.test_object_data = PaymentOptionSerializer(instance=self.test_object).data
        self.test_object_url = self.base_url + str(self.test_object.pk) + '/'

    def test_filter_class(self):
        self.assertEqual(PaymentOptionViewSet.filter_class, PaymentOptionFilter)
