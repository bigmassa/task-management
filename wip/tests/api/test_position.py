...
from wip.api import PositionViewSet
from wip.api.position import PositionFilter
...
class TestAPI(AppTestCase):
    ...
    def setUp(self):
        ...
        self.base_url = reverse('api:position-list')
        self._create_test_object()

    def _create_test_object(self):
        self.test_object = Position.objects.first()
        self.test_object_data = PositionSerializer(instance=self.test_object).data
        self.test_object_url = self.base_url + str(self.test_object.pk) + '/'

    def test_filter_class(self):
        self.assertEqual(PositionViewSet.filter_class, PositionFilter)
