...
from wip.api import JobTypeViewSet
from wip.api.job_type import JobTypeFilter
...
class TestAPI(AppTestCase):
    ...
    def setUp(self):
        ...
        self.base_url = reverse('api:jobtype-list')
        self._create_test_object()

    def _create_test_object(self):
        self.test_object = JobType.objects.first()
        self.test_object_data = JobTypeSerializer(instance=self.test_object).data
        self.test_object_url = self.base_url + str(self.test_object.pk) + '/'

    def test_filter_class(self):
        self.assertEqual(JobTypeViewSet.filter_class, JobTypeFilter)
